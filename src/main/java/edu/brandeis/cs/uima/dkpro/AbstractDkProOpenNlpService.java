...
public class AbstractDkProOpenNlpService {
    ...
    public static JCas opennlpuimaInitDoc() throws  Exception {
        JCas document = createJCasFromPath(
                AbstractDkProOpenNlpService.class.getResource("/uima/opennlp/descriptors/TypeSystem.xml").getPath());
    ...
    public static AnalysisEngine opennlpuimaInit() throws Exception{
        ...
        createDependencyAndBind(sentenceDetector,
                ...
                AbstractDkProOpenNlpService.class.getResource("/en-sent.bin").toString());
        // Configure tokenizer
        ...
        createDependencyAndBind(tokenizer,
                ...
                AbstractDkProOpenNlpService.class.getResource("/en-token.bin").toString());
        ...
        createDependencyAndBind(posTagger,
                ...
                AbstractDkProOpenNlpService.class.getResource("/en-pos-perceptron.bin").toString());
        ...
        createDependencyAndBind(personNer,
                ...
                AbstractDkProOpenNlpService.class.getResource("/en-ner-person.bin").toString());
